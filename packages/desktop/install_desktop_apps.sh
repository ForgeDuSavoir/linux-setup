...
"$SCRIPT_DIR/cliphist/install_cliphist.sh"
...
"$SCRIPT_DIR/rofi/install_rofi.sh"
...
"$SCRIPT_DIR/wl-clip-persist/install_wl-clip-persist.sh"
"$SCRIPT_DIR/wtype/install_wtype.sh"
